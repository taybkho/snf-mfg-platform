        ...
        create or replace transient table MFG_ACCELERATOR.MARTS.mfg_plant_daily_kpis
         as
...
with calendar_days as (
    ...
    from MFG_ACCELERATOR.CORE.core_batches b
    cross join MFG_ACCELERATOR.CORE.fct_production_orders o
...
orders_by_day as (
    ...
    from MFG_ACCELERATOR.CORE.fct_production_orders o
    left join MFG_ACCELERATOR.CORE.core_batches b
